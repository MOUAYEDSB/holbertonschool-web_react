...
class Notifications extends Component {
  ...
  handleDisplayDrawer() {
    // Call handleDisplayDrawer from props
    this.props.handleDisplayDrawer();
  }

  handleHideDrawer() {
    // Call handleHideDrawer from props
        ...
        {displayDrawer && (              
          <div className={css(styles.notifications)} data-testid="notifications">
            <button
              ...
              aria-label="Close"
              onClick={this.handleHideDrawer} // Call handleHideDrawer on close button click
...
Notifications.propTypes = {
  ...
  handleDisplayDrawer: PropTypes.func.isRequired, // Prop for handling display drawer
  handleHideDrawer: PropTypes.func.isRequired // Prop for handling hide drawer
};
